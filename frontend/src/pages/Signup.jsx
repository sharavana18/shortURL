...
import { Link2, Mail, Lock, AlertCircle, ArrowRight, UserPlus } from 'lucide-react';
    ...
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: 'calc(100vh - 80px)', padding: '20px' }}>
      <div className="glass-panel glass-card-interactive" style={{ width: '100%', maxWidth: '420px', padding: '40px 30px', animation: 'fadeIn 0.5s ease' }}>
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <h2 className="title-font" style={{ fontSize: '1.75rem', marginBottom: '8px' }}>Create Account</h2>
          <p style={{ color: 'var(--color-text-muted)', fontSize: '0.9rem' }}>Join now to begin tracking link analytics</p>
        </div>
